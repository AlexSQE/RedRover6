...
Синтаксис «async/await» упрощает работу с промисами (позволяет асинхронный код записывать 
синхронным способом).
Асинхронные функции
...
async function message() {
    ...
    let b = await delay(4000, 'John'); // как только он завершится помещаем его результат в переменную b
    console.log(b)
    ...
    // console.log(a); // "Игорь John Денис"
    // console.log(b)
    console.log(c)
}
